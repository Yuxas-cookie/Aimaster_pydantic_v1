...
class Settings(BaseModel):
    ...
    def validate_mutual_exclusion_of_branching_args(cls, values):
        if (
            sum(
                o is not None
                for o in [
                    values.get("fork_from"),
                    values.get("resume"),
                    values.get("resume_from"),
                ]
            )
            > 1
        ):
    ...
    @validator("x_disable_service", pre=False)
    @classmethod
    ...
    def validate_console(cls, value, values):
        ...
        if (
            ...
            or not values.get("disable_service")
    ...
    @validator("x_executable", pre=True)
    @classmethod
    ...
    @validator("x_file_stream_max_line_bytes", pre=False)
    @classmethod
    ...
    @validator("x_files_dir", pre=True)
    @classmethod
    ...
    @validator("http_proxy", pre=False)
    @classmethod
    ...
    @validator("https_proxy", pre=False)
    @classmethod
    ...
    @validator("program_abspath", pre=True)
    @classmethod
    ...
    @validator("program_relpath", pre=True)
    @classmethod
    ...
    @validator("resume_from", pre=True)
    @classmethod
    ...
    @validator("settings_system", pre=False)
    @classmethod
    ...
    @validator("x_service_wait", pre=False)
    @classmethod
    ...
    @validator("x_stats_gpu_device_ids", pre=True)
    @classmethod
    ...
    @validator("x_stats_neuron_monitor_config_path", pre=True)
    @classmethod
    ...
    @validator("x_stats_open_metrics_endpoints", pre=True)
    @classmethod
    ...
    @validator("x_stats_open_metrics_filters", pre=True)
    @classmethod
    ...
    @validator("x_stats_open_metrics_http_headers", pre=True)
    @classmethod
    ...
    @validator("x_stats_sampling_interval", pre=False)
    @classmethod
    ...
    @validator("sweep_param_path", pre=True)
    @classmethod
    ...
    def _aws_lambda(self) -> bool:
        ...
        from sentry_sdk.integrations.aws_lambda import (  # type: ignore[import]
    ...
    def update_from_settings(self, settings: Settings) -> None:
        ...
        d = {field: getattr(settings, field) for field in settings.__fields_set__}
        if d:
